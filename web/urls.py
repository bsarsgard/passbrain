...
urlpatterns = [
    ...
    url(r'^secret/(?P<secret_id>[0-9]+)/delete/$', views.secret_delete,
            name='secret_delete'),
    url(r'^trust/$', views.trust_create, name='trust_create'),
    url(r'^trust/(?P<trust_id>[0-9]+)/$', views.trust_read,
            name='trust_read'),
    url(r'^trust/(?P<trust_id>[0-9]+)/group/$', views.trust_group_create,
            name='trust_group_create'),
    url(r'^trust/(?P<trust_id>[0-9]+)/user/$', views.trust_user_create,
            name='trust_user_create'),
]
